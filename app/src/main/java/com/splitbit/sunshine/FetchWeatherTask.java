...
import com.splitbit.sunshine.data.WeatherContract;
...
/**
 * Created by imsplitbit on 9/9/14.
 */
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    public FetchWeatherTask(Context context, ArrayAdapter<String> forcastAdapter) {
        mContext = context;
        mForecastAdapter = forcastAdapter;
    }

    private long addLocation(String locationSetting, String cityName, double lat, double lon) {
        Log.v(LOG_TAG, "inserting " + cityName + ", with coord: " + lat + ", " + lon);

        // Check to see if a location with that city name exists in the database
    ...
    protected String[] doInBackground(String... params) {
        ...
        try {
            ...
            // Uncomment to see the built URL
    ...
    */
    ...
    private String formatHighLows(double high, double low) {
        ...
        String unitType = Utility.getPreferredUnits(mContext);
    ...
    private String[] getWeatherDataFromJson(String forecastJsonStr, int numDays,
        ...
        Log.v(LOG_TAG, "Inserting vector of bulk data into the database");
